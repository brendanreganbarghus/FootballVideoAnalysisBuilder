...
def track_cached_players(
    *,
    ...
    if team_color_references_path is None:
...
def _classify_tracks(
    ...
    *,
    ...
    for track in tracks:
        ...
        stable_team = (
            local_labels.most_common(1)[0][0]
            if local_labels
            else classify_color_scores(aggregate, team_profile=team_profile)
        )
